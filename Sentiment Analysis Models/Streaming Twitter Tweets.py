# Streams tweets from the Twitter API and saves them into a file 
# To create a file with thousands of positive and negative tweets  
# The format is preset and customizable.  
...
# Here we are obtaining the negative tweets -
def main():
